...
class Tests {
    ...
    fun queenThreatens() {
        ...
        assertFalse(lesson2.task2.queenThreatens(2, 1, 3, 4))
    }
    ...
    fun daysInMonth() {
        ...
        assertEquals(31, daysInMonth(1, 1495308))
    }

    @Test
    @Tag("2")
    fun circleInside() {
        assertTrue(circleInside(0.0, 0.0, 0.01, 0.3010070958010259, 0.0, 0.5875211550578342))
    ...
    fun brickPasses() {
        ...
        assertFalse(lesson2.task2.brickPasses(2, 2, 1, 1, 1))
        assertFalse(lesson2.task2.brickPasses(1000, 1, 934, 213, 752))
    }
}